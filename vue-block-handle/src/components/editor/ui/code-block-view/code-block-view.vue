...
const hidePreview = computed(() =>
  props.decorations.value.some(isCodeBlockPreviewHiddenDecoration),
)
const showMermaidPreview = computed(
  () => !hidePreview.value && language.value === 'mermaid',
)
