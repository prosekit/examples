...
export default function TableHandle(props: Props) {
  ...
  return (
    <TableHandleRoot className="contents">
      <TableHandleDragPreview />
      <TableHandleDropIndicator />
      <TableHandleColumnPositioner className="block overflow-visible bg-transparent w-min h-min motion-safe:ease-out motion-safe:transition-transform motion-safe:duration-100">
        <TableHandleColumnPopup className="translate-y-[50%] flex motion-safe:duration-100 data-[state=closed]:motion-safe:duration-150 motion-safe:transition-discrete motion-safe:transition-all data-[state=closed]:opacity-0 starting:opacity-0 opacity-100 data-[state=closed]:scale-90 starting:scale-90 scale-100">
          <TableHandleColumnMenuRoot className="contents">
            ...
            <MenuPositioner className="overflow-visible bg-transparent">
              <MenuPopup className="relative block max-h-100 min-w-32 select-none overflow-auto whitespace-nowrap p-1 outline-none z-10 box-border rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-lg [&:not([data-state])]:hidden">
      ...
      >
        <TableHandleRowPopup className="ltr:translate-x-[50%] rtl:translate-x-[-50%] flex motion-safe:duration-100 data-[state=closed]:motion-safe:duration-150 motion-safe:transition-discrete motion-safe:transition-all data-[state=closed]:opacity-0 starting:opacity-0 opacity-100 data-[state=closed]:scale-90 starting:scale-90 scale-100">
