...
export const sampleContent: NodeJSON = {
  ...
  content: [
    ...
    {
      type: 'paragraph',
      content: [{ type: 'text', text: translation['Paragraph'] }],
    },
    {
      type: 'list',
      attrs: { kind: 'bullet' },
      content: [
        {
          type: 'paragraph',
          content: [{ type: 'text', text: translation['Root list item'] }],
        },
        {
          type: 'list',
          attrs: { kind: 'ordered' },
          content: [
            {
              type: 'paragraph',
              content: [{ type: 'text', text: translation['Sub list item'] }],
            },
          ],
        },
        {
              ...
              content: [
                {
                  type: 'paragraph',
                  content: [
                    { type: 'text', text: translation['Completed task'] },
                  ],
                },
              ],
            },
              ...
              content: [
                {
                  type: 'paragraph',
                  content: [
                    { type: 'text', text: translation['Pending task'] },
                  ],
                },
              ],
            },
